      ...
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center border-primary">
            <h2 class="font-weight-light text-primary">Search Result</h2>
...
$sql= mysqli_query($con,"SELECT * FROM item where `city`='$city'   or `main_category`='$pt' or `item_name` like '$name%' ");
