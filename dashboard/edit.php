...
<div class="col-9" >
 </br> <h3 class="page-header" style="color : orange">Update Property...</h3>
  ...
  <form action="" method="post" enctype="multipart/form-data">
    <div class="form-row" style="margin-top:20px ">
      <div class="col-md-4">
        ...
        <input type="file"  name="file1"  onchange="PreviewImage(event,1)" value="<?php echo htmlentities($row['image1']); ?>" required>
      ...
      <div class="col-md-4">
        ...
        <input type="file"  name="file2"  onchange="PreviewImage(event,2)" value="<?php echo htmlentities($row['image2']); ?>" required>
         <input type="text"  name="bs2" style="display:none;" value="<?php echo htmlentities($row['image2']); ?>" />
      </div>

      <div class="col-md-4">
        <img src="<?php echo htmlentities($row['image3']); ?>" id="pre3" height="150px" width="180px">
        <input type="file"  name="file3"  onchange="PreviewImage(event,3)" value="<?php echo htmlentities($row['image3']); ?>" required>
...
<option><?php echo htmlentities($row['main_category']); ?></option>
...
<select class="input-lg form-control"  name ="city"   value="<?php echo htmlentities($row['city']); ?>">
  <option><?php echo htmlentities($row['city']); ?></option>
...
<textarea type="text" class="input-lg form-control" name="pd" placeholder="Type here...." style="height: 150px" ><?php echo htmlentities($row['item_details']); ?></textarea></br>
</div>
